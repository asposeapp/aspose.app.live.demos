...
namespace Aspose.App.Live.Demos.UI.Models.email
{
	public partial class AsposeEmailConversion
	{
		...
		{
			return SaveOstOrPstAsDocument(fileName, folderName, Aspose.Words.SaveFormat.Html);
		}

		Response ConvertPstToSvg(string fileName, string folderName)
		{
			return SaveOstOrPstAsDocument(fileName, folderName, Aspose.Words.SaveFormat.Svg);
		}

		Response ConvertPstToTiff(string fileName, string folderName)
		{
			return SaveOstOrPstAsDocument(fileName, folderName, Aspose.Words.SaveFormat.Tiff);
		}

		Response ConvertPstToJpg(string fileName, string folderName)
		{
			return SaveOstOrPstAsDocument(fileName, folderName, Aspose.Words.SaveFormat.Jpeg);
		}

		Response ConvertPstToBmp(string fileName, string folderName)
		{
			return SaveOstOrPstAsDocument(fileName, folderName, Aspose.Words.SaveFormat.Bmp);
		}

		Response ConvertPstToPng(string fileName, string folderName)
		{
			return SaveOstOrPstAsDocument(fileName, folderName, Aspose.Words.SaveFormat.Png);
		}
