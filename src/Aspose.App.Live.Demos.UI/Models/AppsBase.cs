...
namespace  Aspose.App.Live.Demos.UI.Models
{
	...
	public abstract class AppsBase : ApiController
    {
		///<Summary>
		/// ActionDelegate
		///</Summary>
      ...
      bool deleteSourceFolder = true, string zipFileName = null)
        {
			...
			else if ((checkNumberofPages) && (createZip) && (modelName == "AsposeWordsConversion"))
			{
				Aspose.Words.Document doc = new Aspose.Words.Document(fileName);
				createZip = doc.PageCount > 1;
			}
			// Check presentation file have one or more slides to create zip file
			else if ((checkNumberofPages) && (createZip) && (modelName == "AsposeSlidesConversion"))
			{
			...
			else if ((checkNumberofPages) && (createZip) && (modelName == "AsposeDiagramConversion"))
			{
			...
			else if ((checkNumberofPages) && (createZip) && (modelName == "AsposeEmailConversion"))
			{
			...
			else if ((checkNumberofPages) && (createZip) && (modelName == "AsposeCellsConversion") && (outFileExtension != ".svg"))
			{
			...
			else if ((checkNumberofPages) && (createZip) && (modelName == "AsposeNoteConversion"))
			{
			...
			else if ((checkNumberofPages) && (createZip) && (modelName == "AsposePdfConversion"))
			{
				Aspose.Pdf.Document pdfDocument = new Aspose.Pdf.Document(fileName);
				createZip = pdfDocument.Pages.Count > 1;
			}
			//Check excel file have more than on workseets to create zip or not
			else if ((checkNumberofPages) && (createZip) && (modelName == "AsposeCellsAPmodelNameIsController") && (outFileExtension == ".svg"))
			{
				Aspose.Cells.Workbook workbook = new Aspose.Cells.Workbook(fileName);
