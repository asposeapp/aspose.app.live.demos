...
namespace Aspose.App.Live.Demos.UI.Models.words
{
  ...
  public class AsposeWordsBase : AppsBase
  {
    /// <summary>
    ...
    {
			Aspose.App.Live.Demos.UI.Models.License.SetAsposeWordsLicense();
    ...
    protected void SetDefaultOptions(List<Document> docs)
    {
      if (docs.Count > 0)
      {
        SetDefaultOptions(Path.GetFileName(docs[0].OriginalFileName));
