...
{
	///<Summary>
	/// AsposeCellsBase class 
	///</Summary>

	public class AsposeCellsBase : AppsBase
  {
    /// <summary>
    ...
    protected void SetDefaultOptions(List<Workbook> docs)
    {
      if (docs.Count > 0)
      {
