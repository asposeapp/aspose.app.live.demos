...
using Aspose.App.Live.Demos.UI.Models.words;
using Aspose.App.Live.Demos.UI.Models.email;
using Aspose.App.Live.Demos.UI.Models.cells;
using Aspose.App.Live.Demos.UI.Models.slides;
using Aspose.App.Live.Demos.UI.Models.pdf;
using Aspose.App.Live.Demos.UI.Models.imaging;
using Aspose.App.Live.Demos.UI.Models.html;
using Aspose.App.Live.Demos.UI.Models.tasks;
using Aspose.App.Live.Demos.UI.Models.diagram;
using Aspose.App.Live.Demos.UI.Models.note;
using Aspose.App.Live.Demos.UI.Models.cad;
using Aspose.App.Live.Demos.UI.Models.ThreeD;
using Aspose.App.Live.Demos.UI.Models.gis;
using Aspose.App.Live.Demos.UI.Models.psd;
using Aspose.App.Live.Demos.UI.Models.page;

namespace Aspose.App.Live.Demos.UI.Models.Common
{
	///<Summary>
	/// AsposeConversion class to call conversion method based on product name
	///</Summary>
	public class AsposeConversion : AppsBase
    {
		///<Summary>
        ...
        public static Response ConvertFile(string fileName, string folderName, string outputType, string productName)
        {
			switch (productName)
            {
				...
				case "email":
					AsposeEmailConversion emailController = new AsposeEmailConversion();
